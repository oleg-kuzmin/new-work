# [`Кастомные хуки`](../index.md)

Кастомный хук - это функция, внутри которой вызываются другие хуки.

Как и обычный хук, эта функция может что-то принимать и возвращать.
