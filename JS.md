...
- [`Event (ОБЪЕКТ СОБЫТИЯ)`](./JS/EVENT/Event.md)
  ...
  - [`.clientX (КООРДИНАТЫ X ОТ ОКНА ПРОСМОТРА)`](./JS/EVENT/clientX.md)
  - [`.clientY (КООРДИНАТЫ Y ОТ ОКНА ПРОСМОТРА)`](./JS/EVENT/clientY.md)
  ...
  - [`.key (НАЗВАНИЕ НАЖАТОЙ КЛАВИШИ)`](./JS/EVENT/key.md)
  - [`.pageX (КООРДИНАТЫ X ОТ УГЛА СТРАНИЦЫ)`](./JS/EVENT/pageX.md)
  - [`.pageY (КООРДИНАТЫ Y ОТ УГЛА СТРАНИЦЫ)`](./JS/EVENT/pageY.md)
  - [`.preventDefault() (ОТМЕНЯЕТ ПОВЕДЕНИЕ ПО УМОЛЧАНЮ)`](./JS/EVENT/preventDefault.md)
  - [`.screenX (КООРДИНАТЫ X ОТ УГЛА МОНИТОРА)`](./JS/EVENT/screenX.md)
  - [`.screenY (КООРДИНАТЫ Y ОТ УГЛА МОНИТОРА)`](./JS/EVENT/screenY.md)
