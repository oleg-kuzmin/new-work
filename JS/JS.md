...
- [`Array.from()`](<./ARRAY/ОБЩИЕ МЕТОДЫ/Array.from.md>) создает массив из коллекции
- [`Array.isArray()`](<./ARRAY/ОБЩИЕ МЕТОДЫ/Array.isArray.md>) проверка аргумента на массив
- [`Array()`](<./ARRAY/ОБЩИЕ МЕТОДЫ/Array.md>) создает массив
- [`.includes()`](<./ARRAY/ОБЩИЕ МЕТОДЫ/includes.md>) проверяет наличие в массиве аргумента
- [`.indexOf()`](<./ARRAY/ОБЩИЕ МЕТОДЫ/indexOf.md>) поиск индекса переданного аргумента
