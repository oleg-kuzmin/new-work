# npm ls (Список установленных пакетов)

Команда `npm ls` используется для составления списка установленных пакетов. В отличие от `npm list` показывает древовидное представление всех установленных пакетов вместе с их зависимостями.
