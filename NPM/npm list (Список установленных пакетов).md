...
Команда `npm list` используется для составления списка установленных пакетов npm. В отличие от `npm ls` показывает просто список, тогда как `npm ls` отображает древовидное представление всех установленных пакетов вместе с их зависимостями.
