...
- [`in (9)`](<./Операторы/Оператор in.md>) проверка наличия свойства объекта
...
- [`&&= присваивание с логическим И (2)`](<./Операторы/Присваивание с логическим И.md>) first == false ? first : first = second
- [`||= присваивание с логическим ИЛИ (2)`](<./Операторы/Присваивание с логическим ИЛИ.md>) first == true ? first : first = second
- [`??= присваивание с нулевым слиянием (2)`](<./Операторы/Присваивание c нулевым слиянием.md>) first !== null/undefined ? first : first = second
