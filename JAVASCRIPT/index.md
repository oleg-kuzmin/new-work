...
- [`delete`](<./Операторы/Оператор delete.md>) удаление свойства объекта
- [`in`](<./Операторы/Оператор in.md>) проверка наличия свойства объекта
- [`instanceof`](<./Операторы/Оператор instanceof.md>) проверка принадлежности объекта классу
- [`typeof`](<./Операторы/Оператор typeof.md>) проверка типа
...
- [`(..) скобки (макс)`](./Операторы/Скобки.md)
