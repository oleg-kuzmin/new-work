...
- [`delete`](./Операторы/delete.md) оператор удаления свойства объекта
- [`in`](./Операторы/in.md) оператор проверки наличия свойства объекта
- [`instanceof`](./Операторы/instanceof.md) оператор проверки принадлежности объекта классу
