...
- [`:checked`](./Псевдоклассы/checked.md) отмеченный чекбокс или радио
- [`:child`](./Псевдоклассы/child.md) группа child
- [`:default`](./Псевдоклассы/default.md) начальное состояние
- [`:disabled`](./Псевдоклассы/disabled.md) нельзя взаимодействовать
...
- [`:optional`](./Псевдоклассы/optional.md) выбирает необязательные поля ввода
...
- [`Визуально скрытый элемент`](<./Решения/Визуально скрытый элемент.md>)

## [Теория](#css)

- [`Вложенность селекторов`](<./Теория/Вложенность селекторов.md>)
- [`Код-стайл`](./Теория/Код-стайл.md)
- [`Основные свойства шрифтов`](<./Теория/Основные свойства шрифтов.md>)
