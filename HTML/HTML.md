...
- [`colspan`](./ATTRIBUTES/colspan.md) объединение ячеек в столбцах
...
- [`open`](./ATTRIBUTES/open.md) открывает details, dalog
...
- [`rel <a>`](<./ATTRIBUTES/rel (A).md>) связь ссылки со страницей
- [`rel <link>`](<./ATTRIBUTES/rel (LINK).md>) связь файла со страницей
...
- [`type <ol>`](<./ATTRIBUTES/type (OL).md>) тип маркеров
- [`type <script>`](<./ATTRIBUTES/type (SCRIPT).md>) тип модулей
